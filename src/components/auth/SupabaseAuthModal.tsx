...
export default function SupabaseAuthModal({ isOpen, onClose, onSuccess, defaultTab = 'login', plano }: SupabaseAuthModalProps) {
  ...
  const handleRegister = async (e: React.FormEvent) => {
    ...
    try {
      console.log('Iniciando cadastro para:', registerEmail);
