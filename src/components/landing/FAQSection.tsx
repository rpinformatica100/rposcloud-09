...
const FAQSection = () => {
  const faqs = [
    {
      question: "Como posso começar a usar o RP OS Cloud?",
    ...
    },
    {
      ...
      answer: "Sim, oferecemos um período de teste gratuito de 7 dias com todas as funcionalidades disponíveis para que você possa avaliar nossa plataforma."
    },
    {
  ...
  return (
    <section id="faq" className="w-full py-8 md:py-16 bg-gray-50 dark:bg-gray-900">
      <div className="container px-4 md:px-6">
        <div className="flex flex-col items-center justify-center space-y-4 text-center">
          <div className="space-y-2">
            <div className="inline-block rounded-lg bg-gray-100 px-3 py-1 text-sm dark:bg-gray-800">FAQ</div>
            <h2 className="text-2xl md:text-3xl lg:text-4xl font-bold tracking-tighter">Perguntas Frequentes</h2>
        ...
        <div className="mx-auto max-w-3xl space-y-4 py-6 md:py-8 px-4">
          {faqs.map((faq, index) => (
            <div key={index} className="rounded-lg border bg-background p-4 md:p-6 shadow-sm">
