...
const OrdensForm = () => {
  ...
  const [step, setStep] = useState(1); // Para controle de etapas
    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center space-x-2">
          {/* Mostra os passos de forma visual */}
          <div className="hidden md:flex items-center bg-gray-100 rounded-full p-1">
            <div 
              className={`px-4 py-1 rounded-full text-sm font-medium ${
                step === 1 ? "bg-white shadow" : "text-gray-500"
              }`}
            >
              Informações Básicas
            </div>
            <div 
              className={`px-4 py-1 rounded-full text-sm font-medium ${
                step === 2 ? "bg-white shadow" : "text-gray-500"
              }`}
            >
              Itens e Serviços
            </div>
            <div 
              className={`px-4 py-1 rounded-full text-sm font-medium ${
                step === 3 ? "bg-white shadow" : "text-gray-500"
              }`}
            >
              Revisão
            </div>
      ...
      <Card>
        <CardHeader>
          <CardTitle>
            {step === 1 && "Informações da Ordem de Serviço"}
            {step === 2 && "Adicionar Produtos e Serviços"}
            {step === 3 && "Revisar e Finalizar"}
          </CardTitle>
        </CardHeader>
        <CardContent>
